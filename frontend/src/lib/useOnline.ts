 ...
 * grep of frontend/src). This is the one place that changes, and it is
 * shared everywhere a page needs to disable a submit button or explain a
 * failure.
 *
 ...
 * security-relevant. It drives UI only: it gates buttons and messaging, and
 * the api-client's per-request offline check is what actually protects a
 * call. Every real security decision in the offline flow is made by signed,
 * capped, single-use artifacts that remain sound regardless of what this
 * hook reports.
 */
